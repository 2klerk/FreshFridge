...
function addE(id, name, date, category) {
    ...
    el.innerHTML+='                    <button class="EDIT" id=' + id + ' onclick="edit(this.id)"><img src="ProductList/media/pencil.png" alt="edit" width="20px" height="20px"></button>';
    el.innerHTML+='                    <button class="DEL" id=' + id + ' onclick="del(this.id)"><img src="ProductList/media/trash.png" alt="thrash" width="20px" height="20px"></button>';
